...
import com.connect.demo.FileSourceConnector;
...
public class FileSourceTask extends SourceTask{
	 ...
	 private Long streamOffset;
	    ...
	    public void start(Map<String, String> props) {
	        filename = props.get(FileSourceConnector.FILE_NAME);
	        ...
	        // Connector
	        topic = props.get(FileSourceConnector.TOPIC_NAMES);
	        batchSize = Integer.parseInt(props.get(FileSourceConnector.TASK_BATCH_SIZE));
	    }
	    ...
	    public List<SourceRecord> poll() throws InterruptedException {
	        if (stream == null) {
	            try {
	                ...
	                Map<String, Object> offset = context.offsetStorageReader().offset(Collections.singletonMap(FILE_NAME, filename));
	                if (offset != null) {
	    ...
	    private Map<String, String> offsetKey(String filename) {
	        return Collections.singletonMap(FILE_NAME, filename);
	    }
